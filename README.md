...
[Isaac Lab](https://isaac-sim.github.io/IsaacLab/) 上で exp_030 相当の **両脚歩行 PPO** を学習する拡張です（MuJoCo 本線の Isaac Sim 移植版）。

| 項目 | 内容 |
|------|------|
| パッケージ | [isaac-lab/](isaac-lab/) |
| タスク | `YuukiLab-BipedPpoWalk-Direct-v0` |
| 詳細 | [isaac-lab/README.md](isaac-lab/README.md) |

```bash
cd isaac-lab
python -m pip install -e source/yuuki_isaac_lab
python scripts/rsl_rl/train.py --task YuukiLab-BipedPpoWalk-Direct-v0 --headless
```
