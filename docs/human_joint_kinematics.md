...
人間の限界は、真下から後ろに約30°まで、脚を前に上げると真下から約110°まで。  
論理角では-20°～120°

### 膝関節

<img src="images/human_knee_range.jpg" alt="膝関節可動域" width="300">

人間の限界は、真下から前には曲がらず、後ろに約100°まで。  
論理角では0°～100°

### 踵関節

<img src="images/human_ankle_range.jpg" alt="踵関節可動域" width="300">

人間の限界は、真横からつま先を上に持ち上げる方向に約20°  
地面を蹴る方向に約90°まで。  
論理角では-20°～90°
...
`experiments/exp_001_2joint_a2c` では膝の「人間らしい後方屈曲」にボーナス:
...
007 ではコメント上、**膝ヒンジ +Y: `ctrl`/`qpos` > 0 が人間と同じ後方屈曲**と定義（`exp_001_2joint_a2c/env.py`）。
