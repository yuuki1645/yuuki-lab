...
def add_rsl_rl_args(parser: argparse.ArgumentParser):
    ...
    arg_group.add_argument(
        ...
        help="Logger module to use. Default: wandb.",
    )
    arg_group.add_argument(
        "--log_project_name",
        type=str,
        default=None,
        help="WandB/Neptune project name. Default: task config wandb_project / experiment_name.",
    )
    arg_group.add_argument(
        "--wandb_mode",
        type=str,
        ...
        help="WandB sync mode. Default: online (cloud sync). Use offline for air-gapped runs.",
    )
