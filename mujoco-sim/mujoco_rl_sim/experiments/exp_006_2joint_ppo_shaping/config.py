"""exp_006: 2 関節脚 PPO + exp_005 ベースの足底幾何観測（50 Hz 制御）。

報酬・終了・PPO は exp_005 と同一。観測のみ toe/heel 底 site Z と膝・IMU のかかと底相対 XZ を追加。
"""
...
WANDB_RUN_NAME = ""
WANDB_ENTITY = ""
WANDB_TAGS = ("ppo", "2joint", "shaping", "foot_geom_obs")
WANDB_TERMINATION_ROLLING_WINDOW = 100

# exp_005 との比較用メタデータ
COMPARE_BASELINE_EXP = "exp_005_2joint_ppo_shaping"
