"""exp_009: exp_008 + 飛翔前傾で前進報酬を減衰・長飛翔ペナルティ・長エピソード。

exp_008 分析: 前傾ダイブ（imu_zaxis_x>0.7）で IMU 高さ低下 → imu_z 終了が主因。
...
COMPARE_BASELINE_EXP = "exp_008_2joint_ppo_hop_shaping"
