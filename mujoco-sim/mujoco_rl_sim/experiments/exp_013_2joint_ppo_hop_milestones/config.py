"""exp_013: exp_010 + 累積距離マイルストーン報酬（1〜10 m）。
...
# 累積前進マイルストーン（exp_013）— 各距離を初めて通過した step で 1 回
MILESTONE_DISTANCES_M = (1.0, 2.0, 3.5, 5.0, 7.5, 10.0)
MILESTONE_BONUS = 4.0
