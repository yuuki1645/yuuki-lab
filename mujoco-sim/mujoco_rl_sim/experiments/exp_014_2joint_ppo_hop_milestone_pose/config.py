"""exp_014: exp_010 ベスト + 1〜10m マイルストーン + 生存ボーナス + 姿勢終了緩和。

現状ベスト exp_010 final ~3.1 m。10 m 直達のスパース報酬と早期終了緩和。

exp_009 途中停止（u2500）: ~2 m、low_upright 終了。10 m 見込み薄。
exp_008 最良 u1500: ~2.75 m（転移起点）。
...
PROGRESS_REWARD_SCALE = 22.0
PROGRESS_MIN_UPRIGHT = 0.65

MILESTONE_DISTANCES_M = (1.0, 2.5, 4.0, 6.0, 8.0, 10.0)
MILESTONE_BONUS = 5.0
MILESTONE_MIN_UPRIGHT = 0.65

SURVIVAL_BONUS_SCALE = 0.12
SURVIVAL_MIN_UPRIGHT = 0.68
SURVIVAL_MIN_IMU_Z = 0.43
...
# --- 姿勢ベース早期終了 --------------------------------------------------------
MIN_IMU_Z = 0.37
MIN_IMU_Z_STANCE = 0.33  # 立脚中のみ緩和
MIN_IMU_UPRIGHT = 0.50
