"""exp_019: 両脚バイペッド前進 PPO（10 DOF 全サーボ・テレメトリ連携）。

exp_018 と同一の学習設定。既定で現実時間ステップと Hub テレメトリ（Socket.IO 8791）を有効にする。
"""
...
COMPARE_BASELINE_EXP = "exp_018_biped_ppo_hop_balance"
