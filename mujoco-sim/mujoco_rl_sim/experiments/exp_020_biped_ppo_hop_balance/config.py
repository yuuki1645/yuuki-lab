"""exp_020: 両脚バイペッド前進 PPO（contract 駆動・exp_019 と同一ハイパラ）。

``mujoco_rl_sim.contract`` の biped_ppo_v1 で観測・テレメトリを定義。学習本体は exp_019 と同じ。
"""
...
COMPARE_BASELINE_EXP = "exp_019_biped_ppo_hop_balance"
