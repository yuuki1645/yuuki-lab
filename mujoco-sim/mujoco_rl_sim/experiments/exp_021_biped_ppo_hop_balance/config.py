"""exp_021: 足裏板 25 cm バイペッド PPO（exp_020 派生・contract 駆動）。

``model/main.xml`` の足裏アルミ板を 30 cm → 25 cm（人間サイズ寄り）に短縮。
学習ハイパラ・観測契約は exp_020 と同一（biped_ppo_v1）。
"""
...
COMPARE_BASELINE_EXP = "exp_020_biped_ppo_hop_balance"
