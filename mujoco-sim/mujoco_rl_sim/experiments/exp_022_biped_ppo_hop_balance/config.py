"""exp_022: 足裏 25 cm バイペッド PPO（exp_021 派生・contact 走査なし）。

exp_021 と同一モデル・学習ハイパラ。``data.contact`` 走査と接触終了を削除し、
stance / aerial 判定は IMU 高さ（``STANCE_IMU_Z_THRESHOLD``）のみ。
"""
...
# imu_z がこれ未満なら stance（aerial カウンタをリセット）
STANCE_IMU_Z_THRESHOLD = 0.48
