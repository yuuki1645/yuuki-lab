...
Hub テレメトリ（`biped_ppo_v1`・**48 次元**）と PPO 学習ループの **契約正本**（本実験フォルダ内 `contract/`）。

脚 10 + バランス棒 2 DOF（48 次元版 `biped_ppo_v1`）。
...
| 実験 | 契約の使い方 |
|------|----------------|
| exp_025 | `experiment_contract.py` + `run_ppo_train`（48 次元） |

## モジュール

| ファイル | 役割 |
|----------|------|
| `biped_v1.py` | **契約定義（48 次元・正本）** |
